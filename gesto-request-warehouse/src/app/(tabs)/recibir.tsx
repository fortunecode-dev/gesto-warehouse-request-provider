...
export default function PendingTransferView() {
    ...
    const [confirmRejectVisible, setConfirmRejectVisible] = useState<boolean>(false);
    ...
    const handleRejectReceive = useCallback(async () => {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: themeColors.background }}>
            ...
            <Modal visible={confirmRejectVisible} transparent animationType="fade">
                <View style={styles.modalOverlay}>
                    <View style={[styles.modalBox, { backgroundColor: themeColors.card }]}>
                        <Text style={[styles.modalTitle, { color: themeColors.text }]}>
                            Confirmar
